function [Patches, warped_images]= InitializeTrainingSet_search_Patch(train_sketch_path, sketch_list, model_path, n_sketches, patch_size, overlap_size)
...
for i = 1:n_sketches,
    ...
    warped_images{i} = SubSample(warped_img,67,67);
    figure;imshow(warped_images{i});
