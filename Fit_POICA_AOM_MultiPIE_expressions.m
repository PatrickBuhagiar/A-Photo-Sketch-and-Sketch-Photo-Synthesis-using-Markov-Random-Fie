...
path = '.\02_data\02_Multi-PIE\';


%% Read Images

test_path = [path '02_test_images\02_expressions\'];
...
for i = 1:n_data 
  ...
  try
    ...
    [fitted(:,:,i)] = POICA_AOM_MultiPIE(param, AAM, image_path); 
  catch fitting_err
    disp('Fitting_Error!');
  end
...
plotFinalResults2(ground, fitted);
