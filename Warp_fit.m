...
train_sketch_path = '..\02_data\TrainingSketches\';
...
train_photo_path = '..\02_data\TrainingPhotos\';
...
Input_Patches = InitializeTrainingSet(test_path, input_list, model_path, n_input,  patch_size, overlap_size);
n_patches = length(Input_Patches{1});


% %% Obtain best matches
candidate_patches = PseudoImage(Input_Patches, Training_Sketch_Patches, Training_Photo_Patches);

% calculate phi
phi_patches = Calculate_phi(Input_Patches, candidate_patches, sigma);
