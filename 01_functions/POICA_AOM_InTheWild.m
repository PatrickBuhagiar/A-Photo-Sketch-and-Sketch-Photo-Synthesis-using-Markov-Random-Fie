function [final_shape] = POICA_AOM_InTheWild(param, AAM, image_path)
  ...
  levels = {1, 2, 3, 4};
  param.AAM.levels = cell2mat(levels(3));
  ...
  % Noise Exponent
  noise_exp = {1, 2/3, 1/2, 1/3};
  param.noise_exp = cell2mat(noise_exp(4));
