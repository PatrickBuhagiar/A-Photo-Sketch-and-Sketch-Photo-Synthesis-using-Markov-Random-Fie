function [list, cumulative_shape_RMSE] = plotFinalResults1(shape_RMSE)
  ...
  title('Multi-PIE frontal neutral','Interpreter', 'tex', 'fontsize', 15)
  grid on
